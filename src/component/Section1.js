...
function Section1() {
  ...
  const user_id = localStorage.getItem('userrId')
  ...
  const likesPost=(post_id)=>{
    fetch(`http://localhost:8000/api/v1/posts/likes/${post_id}`,{
      method:"POST",
    ...
    .then((data)=>{
      setLikes(data)
      if (data.msg === 'you already liked post') {
              ...
              <div className="blog-post-div">
                <div className="blog-post-div-inner1">
                  <div className="blog-post-div-inner1-div1">
                    <img
                      className="blog-post-image01"
                      src={item.category_id.img}
                      alt=""
                    />
                    <p className="blog-post-div-inner1-p1">
                ...
                <Link className="singlepost-link" to={`/singlepostpage/${item._id}`}>
                  <h1 className="blog-post-div-h1">{item.title}</h1>
                  <div className="blog-post-div-inner2">
                    <img
                      className="blog-post-div-inner2-img"
                      src={backend + "/" + item.img}
                      alt=""
                    />
                  </div>
                </Link>
                ...
                <div className="comments-and-like-div">
                  <div className="comments-and-like-div-innerd1">
                    <ImArrowUp className="comments-and-like-div-innerd1-arrow-up" onClick={()=>likesPost(item._id)}/>
                    <p className="comments-and-like-div-innerd1-p1">
                      {item.likes.length}
                    </p>
                  ...
                  <div className="comments-and-like-div-innerd2">
                    ...
                    <p className="comments-and-like-div-innerd1-p1">
                      {item.comments_id.length}
                    </p>
                    {/* <ImArrowDown className="comments-and-like-div-innerd1-arrow-down"/> */}
                    <p className="comments-and-like-div-innerd1-p1-1">
                      Comments
                    </p>
                  </div>
                  <div className="comments-and-like-div-innerd2">
